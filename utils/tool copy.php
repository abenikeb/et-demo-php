...
// //    print_r($stringB);
  ...
  $stingAqured = "appid=850259476582401&merch_code=100000108&merch_order_id=1672147786909&method=payment.preorder&nonce_str=BJXP5NE5HFLUHK32V8HC8X3UNBC7GFXT&notify_url=https://www.google.com&timeout_express=120m&timestamp=1672147787&title=diamond_100&total_amount=100&trade_type=InApp&trans_currency=USD&version=1.0";
...
// echo "ABENEII";
// print_r();
    // return getRSAKeys(hash("sha256", $stingAqured));
     //return getRSAKeys($stingAqured);
    // return getRSAKeys(hash("sha256", $stingAqured));
    return getRSAKeys($stingAqured);
